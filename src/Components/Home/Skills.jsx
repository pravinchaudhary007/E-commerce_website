  ...
  return (
    ...
    <div className='w-auto h-screen overflow-hidden  bg-backimage bg-cover bg-center md:p-4 sm:p-3 p-7 lg:p-5 '>
      <div className='w-auto max-w-screen flex-auto justify-center items-center '>
        ...
        <div className='grid grid-cols-1 snap-center sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 lg:gap-6 md:gap-4 sm:gap-3 gap-2 w-auto lg:h-[600px] md:h-[500px] sm:h-[420px] h-[420px] overflow-auto'>
          {skills.map((val, id) => (
            <div key={id} className=' border-none outline-none h-auto lg:p-4 md:p-3 p-2  rounded-lg bg-neutral-50 shadow-xl flex flex-col items-center text-center'>
              <val.logo title={val.head} className=' hover:animate-bounce hover:delay-300 duration-3 00 ease-in-out md:h-14 md:w-14  lg:h-16 lg:w-16 sm:h-12 sm:w-12 h-10 w-10 rounded-full bg-white shadow-lg mt-1 border-2 border-[#41a441] p-2 text-[#41a441]' />
