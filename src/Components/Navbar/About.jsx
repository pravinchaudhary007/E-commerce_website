...
const About = () => {
  return (<>
    <div className='max-w-full w-auto h-auto bg-cover bg-no-repeat bg-neture lg:p-14 md:p-10 sm:p-8 p-4 '>
     ...
     <p >Welcome to [Your E-Commerce Website Name], your one-stop destination for all your shopping needs! We are 
      ...
      <p>At [Your E-Commerce Website Name], we offer a wide range of products across various categories, including
       ...
       <p >We pride ourselves on our commitment to quality, customer satisfaction, and fast delivery. Our team works
         tirelessly to curate a selection of products that meet the highest standards, and we partner with trusted
          ...
          <p >Founded with the vision of creating a seamless and enjoyable online shopping experience, [Your E-Commerce
             Website Name] brings together a vast selection of items from top brands and reliable sellers. Whether 
      ...
      <p >Thank you for choosing [Your E-Commerce Website Name] as your preferred online shopping destination. We are
         excited to be part of your shopping journey and are committed to exceeding your expectations with every 
         purchase.</p>

         <p>Privacy Statement 👉 Your information is secure with us. For details on how we use your data, please review our <a href="/privacy-policy">Privacy Policy</a>.</p>
         </div>
    </div>
    </>)
}
